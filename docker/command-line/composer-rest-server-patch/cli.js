...
const yargs = require('yargs')
    ...
    .option('z', { alias: 'zzz', describe: 'zzz', type: 'string', default: process.env.BASE_URL || undefined })
    .option('b', { alias: 'base', describe: 'The base url', type: 'string', default: process.env.BASE_URL || undefined })
...
var configJson = {
    "restApiRoot": yargs.b + "api",
    "host": "0.0.0.0",
    "port": 3000,
    "url": "http://localhost:3000/",
    "cookieSecret": "5dcbbeb2-cd63-4a3e-a0a3-70127bf74a66",
    "remoting": {
        "context": false,
        "rest": {
        "handleErrors": false,
...
console.log(yargs.z);
var configJsonString = JSON.stringify(configJson);
fs.writeFileSync("/home/composer/packages/" + yargs.z + "/server/config.json", configJsonString);
